...
<template>
  ...
  >
    ...
    <UPageSection
      ...
      :ui="{
        container: 'lg:px-0 2xl:px-20 mx-0 max-w-none md:mr-10 mt-5',
        features: 'gap-0'
      }"
      reverse
    >
    ...
    >
      ...
      <UPricingPlans scale>
        <UPricingPlan
          ...
          :button="plan.button"
          :ui="{titleWrapper:'mx-auto font-bold', description:'mx-auto font-bold text-3xl text-primary'}"
        />
      </UPricingPlans>
    </UPageSection>
    <USeparator :ui="{ border: 'border--primary/30' }" />
